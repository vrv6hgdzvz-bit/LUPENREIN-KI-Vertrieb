...
export default async function Page({params}:{params:Promise<{token:string}>}){
 ...
 return <main className="publicShell offerPreviewShell"><article className="offerPublic offerPublicCanvas">
  ...
  <section className="onlineDocumentPage onlineOfferPage">
   <header className="onlineLetterhead"><img src="/lupenrein-logo.png" alt="LUPENREIN Service GmbH"/></header>
  ...
  <section className="onlineDocumentPage onlineLvPage">
   ...
   </section><section className="onlineLvDecision noPrint"><h2>Ihre Entscheidung</h2><PublicOfferAcceptance token={token} status={row.status}/></section><footer className="onlinePageFooter">LUPENREIN Service GmbH · Metzer Str. 18 · 13595 Berlin &nbsp;&nbsp;|&nbsp;&nbsp; Telefon: 030 648 22 623 &nbsp;&nbsp;|&nbsp;&nbsp; info@lupenrein-berlin.de</footer>
  </section>
 </article></main>
}
